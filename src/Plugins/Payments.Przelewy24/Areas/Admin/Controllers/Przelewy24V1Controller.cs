...
using Payments.Przelewy24V1.Models;
using System.Linq;
...
namespace Payments.Przelewy24V1.Controllers
{
    ...
    public class Przelewy24V1Controller : BasePaymentController
    {
        ...
        public Przelewy24V1Controller(IWorkContext workContext,
        ...
        public async Task<IActionResult> Configure()
        {
            ...
            var payPalStandardPaymentSettings = _settingService.LoadSetting<Przelewy24V1PaymentSettings>(storeScope);
