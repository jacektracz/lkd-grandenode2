...
{
    public class Przelewy24V1HttpClient : IPrzelewy24V1HttpClient
    {
        private readonly HttpClient _client;
        private readonly Przelewy24V1PaymentSettings _paypalStandardPaymentSettings;
        private readonly ILogger _logger;
        public Przelewy24V1HttpClient(HttpClient client, Przelewy24V1PaymentSettings paypalStandardPaymentSettings, ILogger logger)
        {
            _client = client;
