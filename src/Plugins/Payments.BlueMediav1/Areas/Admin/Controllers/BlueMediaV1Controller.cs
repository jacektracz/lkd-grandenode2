...
using Payments.BlueMediaV1.Models;
using System.Linq;
...
namespace Payments.BlueMediaV1.Controllers
{
    ...
    public class BlueMediaV1Controller : BasePaymentController
    {
        ...
        public BlueMediaV1Controller(IWorkContext workContext,
        ...
        public async Task<IActionResult> Configure()
        {
            ...
            var payPalStandardPaymentSettings = _settingService.LoadSetting<BlueMediaV1PaymentSettings>(storeScope);
