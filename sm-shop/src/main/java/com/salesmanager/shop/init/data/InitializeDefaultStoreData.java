...
@Component
public class InitializeDefaultStoreData implements InitData {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(InitializeDefaultStoreData.class);
	...
	public void initInitialData() throws ServiceException {
		...
		ProductType generalType = productTypeService.getProductType(ProductType.GENERAL_TYPE);
		 ...
		 Category book = new Category();
		    ...
		    book.setDescriptions(new HashSet<>(descriptions));
		    ...
		    novs.setDescriptions(new HashSet<>(descriptions2));
		    ...
		    tech.setDescriptions(new HashSet<>(descriptions4));
		    ...
		    web.setDescriptions(new HashSet<>(descriptions3));
		    ...
		    fiction.setDescriptions(new HashSet<>(fictiondescriptions));
		    ...
		    business.setDescriptions(new HashSet<>(businessdescriptions));
		    ...
		    cloud.setDescriptions(new HashSet<>(clouddescriptions));
